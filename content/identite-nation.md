...
title: Identité de nation
excerpt: Nom, devise, drapeau, biographie RP, doctrine et dirigeant : ce qui définit ton pays aux yeux des autres.
position: 50
published: true
---
...
- **Gentilé**, **capitale**, **devise** (la phrase, pas la monnaie),
  **nom de la monnaie**.
- Une **notice biographique** courte, et une **page RP** plus longue en
  Markdown, publiées sur ta fiche pays publique.
- Ton **drapeau** (généré ou importé) et une galerie d’images RP.

## Doctrine, idéologie et trait dirigeant
